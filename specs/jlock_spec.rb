...
describe Stacky::JLock, 'constructor' do
  context 'creating from a string' do
    ...
    it 'waiting state' do
      result = Stacky::JLock.new '- waiting on <7c46f65b8> (a java.lang.Object)'
    ...
    it 'parking to wait' do
      result = Stacky::JLock.new '- parking to wait for  <7c3e234a0> (a java.util.concurrent.locks.AbstractQueuedSynchronizer$ConditionObject)'
      expect(result.locked).to be false
